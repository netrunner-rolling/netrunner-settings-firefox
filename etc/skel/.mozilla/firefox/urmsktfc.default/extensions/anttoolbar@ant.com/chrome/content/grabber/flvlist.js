...
var antvd = (function(antvd) {
    ...
    AntFlvListListener.prototype = {
        /** @type BaseVideoRequest */ videoRequest: null,
    ...
    function AntFlvList() {
        ...
        this.download = function (videoRequest) {
            ...
            downloadPromise.then(
                function() {
                    antvd.AntLib.toLog("Video has been downloaded");
                ...
                , function(ex) {
                    ...
                    if (ex instanceof antvd.MediaLibraryError) {
                        ...
                        case antvd.MediaConverterError.E_JOIN_MISSING_INPUT:
                            reportFailure(
                                "MediaConverter.NoInput"
                                , videoRequest.displayName);
                            break;
                        ...
                        case antvd.MediaConverterPackageError.E_CONF_NOTEXECUTABLE:
                            ...
                            break;
                        default:
                            reportFailure("MediaConverterPackage.UnexpectedError"
                                          , ex.code);
                            break;
                        }
                    } else {
                        ...
                        /** unexpected error */
                        antvd.AntLib.toLog("Error is: " + ex + "\nCode: " + ex.code);
                    }
                }).then(
                    null
                    , function(ex) {
                        antvd.AntLib.logError("[UI]: Unexpected error", ex);
                    });
        };
        ...
        var reportDownload = function(mediaRequest) {
            if (!mediaRequest)
                return Promise.reject(
                    new Error("'mediaRequest' is a mandatory argument"));
            try {
                if (!AntPrefs.isVideorepportsOn || antvd.AntLib.inPrivate)
                    return Promise.resolve();
                return mediaRequest.reportDownload();
            } catch (ex) {
                antvd.AntLib.logError("Unexpected exception occurred", ex);
            ...
            try {
                ...
                alertsService.showAlertNotification(
                    ...
                    , complete
                        ...
                        : antvd.AntLang.getString("MediaConverterPackage.BeginInstallConverter"));

            } catch (ex) {
                antvd.AntLib.logError("Failed to displayed a notification", ex);
            }
        };
        ...
        var reportNoConverter = function(messageId) {
            ...
            let helpButton = {
                ...
                popup: null,
                callback: function() {
                    antvd.Options.getDefault().showHelp(
        ...
        var reportFailure = function(id) {
            ...
            let helpButton = {
                ...
                popup: null,
                callback: function() {
                    antvd.AntLib.openURL(
                        "http://www.ant.com/toolbar/firefox/help", 1);
                }
            };
    ...
    /** @expose */ antvd.AntFlvList = new AntFlvList();
    return antvd;
})(antvd);
